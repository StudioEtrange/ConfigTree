...
def full_tree():
    global td
    td = Tree({"1": 1, "a.2": 2, "a.b.3": 3, "a.b.4": 4, "a.b.5": 5, "a.b.6": 6})
...
def tree_eq_dict_test():
    tools.eq_(td, {"1": 1, "a.2": 2, "a.b.3": 3, "a.b.4": 4, "a.b.5": 5, "a.b.6": 6})
...
def iter_and_keys_test():
    tools.eq_(sorted(list(iter(td))), ["1", "a.2", "a.b.3", "a.b.4", "a.b.5", "a.b.6"])
...
def rare_iterators_test():
    ...
    tools.eq_(sorted(list(td.rare_items()), key=key), [("1", 1), ("a", td["a"])])

    tools.eq_(sorted(list(td["a"].rare_keys())), ["2", "b"])
    tools.eq_(sorted(list(td["a"].rare_values()), key=key), [2, td["a.b"]])
    tools.eq_(sorted(list(td["a"].rare_items()), key=key), [("2", 2), ("b", td["a.b"])])
...
def rare_copy_test():
    rd = td.rare_copy()
    tools.eq_(rd, {"1": 1, "a": {"2": 2, "b": {"3": 3, "4": 4, "5": 5, "6": 6}}})

    rd = td["a"].rare_copy()
    tools.eq_(rd, {"2": 2, "b": {"3": 3, "4": 4, "5": 5, "6": 6}})
