...
with open(path.join(project_root, "configtree", "__init__.py")) as f:
...
man_pages = [
    ("index", "configtree", u"ConfigTree Documentation", [u"Dmitry Vakhrushev"], 1)
]
